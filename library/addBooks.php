      ...
      <h2>Books</h2>
       ...
       <form action="addBooksLogic.php" method="POST">
        <div class="form-floating">
          <input type="text" class="form-control" id="floatingInput" placeholder="Book tittle" name="tittle" >
        ...
        <div class="form-floating">
          <input type="text" class="form-control" id="floatingInput" placeholder="Book Description" name="description" >
         ...
         <button  class="w-20 btn btn-lg btn-primary " type="submit" name="submit"> Add Book </button> 
       </form>
