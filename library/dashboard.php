          ...
          <tbody>
            <?php foreach ($users_data as $user_data) { ?>
               ...
               <tr>
                ...
                <td><a href="editUsers.php?id=<?= $user_data['id'];?>" class="btn btn-sm btn-primary">Update</a></td>
                  <!-- If we want to delete a user we need to link into deleteUsers.php -->
                <td><a href="deleteUsers.php?id=<?= $user_data['id'];?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this user?');">Delete</a></td>
              </tr>
