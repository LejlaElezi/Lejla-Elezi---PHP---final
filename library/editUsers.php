  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="table-responsive">
        ...
        <form action="editUsersLogic.php" method="post">
        ...
        <div class="form-floating">
          <input type="is_admin" class="form-control" id="floatingInput" placeholder="is_admin" name="is_admin" value="<?php echo  $user_data['is_admin'] ?>">
