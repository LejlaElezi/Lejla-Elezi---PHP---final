  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="table-responsive">
        ...
        <form action="editBookLogic.php" method="post">
        ...
        <div class="form-floating">
          <input type="text" class="form-control" id="floatingInput" placeholder="tittle" name="tittle" value="<?php echo  $book_data['tittle'] ?>">
          <label for="floatingInput">Book Tittle</label>
        </div>
        <div class="form-floating">
          <input type="text" class="form-control" id="floatingInput" placeholder="Book Description" name="description" value="<?php echo  $book_data['description'] ?>">
          <label for="floatingInput">Book Description</label>
        </div>
        <div class="form-floating">
          <input type="" class="form-control" id="floatingInput" placeholder="Book Image" name="image" value="<?php echo  $book_data['image'] ?>">
